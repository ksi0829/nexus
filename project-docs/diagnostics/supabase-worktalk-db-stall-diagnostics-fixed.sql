...
declare
  ...
  v_wal_lsn_start pg_lsn := pg_current_wal_lsn();
  v_wal_lsn_after_message_insert pg_lsn := null;
  v_wal_lsn_return_ready pg_lsn := null;
begin
  ...
  v_stage_marks := v_stage_marks || jsonb_build_object(
    ...
    'wal_lsn_start', v_wal_lsn_start::text
  );
  ...
  v_wal_lsn_after_message_insert := pg_current_wal_lsn();
  v_activity_snapshots := v_activity_snapshots || jsonb_build_object(
  ...
  v_stage_marks := v_stage_marks || jsonb_build_object(
    ...
    'wal_lsn_after_message_insert', v_wal_lsn_after_message_insert::text,
    'wal_bytes_message_insert',
      pg_wal_lsn_diff(v_wal_lsn_after_message_insert, v_wal_lsn_start)
  );
  ...
  values (
    ...
    v_wal_lsn_start::text,
    v_wal_lsn_after_message_insert::text,
    null,
    pg_wal_lsn_diff(v_wal_lsn_after_message_insert, v_wal_lsn_start),
    null
  )
  ...
  v_wal_lsn_return_ready := pg_current_wal_lsn();
  ...
  v_stage_marks := v_stage_marks || jsonb_build_object(
    ...
    'wal_lsn_return_ready', v_wal_lsn_return_ready::text,
    'wal_bytes_total', pg_wal_lsn_diff(v_wal_lsn_return_ready, v_wal_lsn_start)
  );
